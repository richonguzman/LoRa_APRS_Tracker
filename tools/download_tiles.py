...
Usage:
    python download_tiles.py --region IDF --bbox 1.4,48.1,3.6,49.2 --zoom 10,12,14
    python download_tiles.py --region ARA --bbox 3.5,44.5,7.2,46.5 --zoom 10,12,14
...
REGIONS = {
    ...
    'ARA': {
        ...
        'bbox': (2.0, 44.1, 7.2, 46.8)
    },
    'PACA': {
        'name': "Provence-Alpes-Côte d'Azur",
        'bbox': (4.2, 42.9, 7.7, 45.1)
    },
    'OCC': {
        'name': 'Occitanie',
        'bbox': (-0.4, 42.3, 4.9, 45.0)
    },
    'NAQ': {
        'name': 'Nouvelle-Aquitaine',
        'bbox': (-1.8, 44.0, 2.6, 47.2)
    },
    'BRE': {
        'name': 'Bretagne',
        'bbox': (-5.2, 47.2, -0.9, 48.9)
    },
    'NOR': {
        'name': 'Normandie',
        'bbox': (-2.0, 48.2, 1.8, 49.8)
    },
    'HDF': {
        'name': 'Hauts-de-France',
        'bbox': (1.4, 48.8, 4.3, 51.1)
    },
    'GES': {
        'name': 'Grand Est',
        'bbox': (3.4, 47.4, 8.3, 49.6)
    },
    'BFC': {
        'name': 'Bourgogne-Franche-Comté',
        'bbox': (2.8, 46.1, 7.2, 48.4)
    },
    'PDL': {
        'name': 'Pays de la Loire',
        'bbox': (-2.6, 46.2, 0.9, 48.6)
    },
    'CVL': {
        'name': 'Centre-Val de Loire',
        'bbox': (0.0, 46.3, 3.2, 48.6)
    },
    'COR': {
        'name': 'Corse',
